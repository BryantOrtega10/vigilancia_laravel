                    ...
                    <div class="col-md-3 col-12">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('rol') is-invalid @enderror" id="rol" name="rol">
                                <option value="vigilante" @if (old('rol') == 'vigilante') selected @endif>Vigilante</option>
                                <option value="admin_sede" @if (old('rol') == 'admin_sede') selected @endif>Administrador de sede</option>
                            </select>
                            @error('rol')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
