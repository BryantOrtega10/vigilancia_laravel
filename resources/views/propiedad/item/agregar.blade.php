...
@section('content')
    <div class="card">
        <form action="{{ route('propiedad.grupo.item.agregar',['id' => $grupo->id]) }}" method="post">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nombre') is-invalid @enderror" id="nombre" name="nombre" placeholder="Nombre:" value="{{ old('nombre',$nombre_predeterminado) }}">
                            @error('nombre')
                ...
                <div class="row">
                    <div class="col-md-3 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nombres') is-invalid @enderror" id="nombres" name="nombres" placeholder="Nombre:" value="{{ old('nombres') }}">
                            @error('nombres')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="row">
                    <div class="col-md-3 col-12">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('celular_p') is-invalid @enderror" id="celular_p" name="celular_p" placeholder="Celular principal:" value="{{ old('celular_p') }}">
                            @error('celular_p')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-md-3 col-12">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('celular_s') is-invalid @enderror" id="celular_s" name="celular_s" placeholder="Celular secundario:" value="{{ old('celular_s') }}">
                            @error('celular_s')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-4"> 
                        <button class="btn btn-secondary agregar-vehiculo" type="button"><i class="fas fa-plus"></i></button>
                    </div>                    
                </div>
                        ...
                        <div class="row align-items-center vehiculo-unidad">
                            <div class="col-md-3 col-5">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="tipo_vehiculo_{{$i}}" name="tipo_vehiculo[]">
                                        <option value="1" @if (old('tipo_vehiculo.'.$i) == "1") selected @endif>Carro</option>
                                        <option value="2" @if (old('tipo_vehiculo.'.$i) == "2") selected @endif>Moto</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="vehiculo_{{$i}}" name="vehiculo[]" placeholder="Vehículo:" value="{{old('vehiculo.'.$i)}}" >
                                </div>
                            </div>
                            <div class="col-1">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-10 col-4"> 
                        <button class="btn btn-secondary agregar-residente" type="button"><i class="fas fa-plus"></i></button>
                    </div>                    
                </div>
                        ...
                        <div class="row align-items-center residente-unidad">
                            <div class="col-md-3 col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="residente_n_{{$i}}" name="residente_n[]" placeholder="Nombre residente:" value="{{old('residente_n.'.$i)}}" >
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="form-group">
                                    <label for="residente_c_{{$i}}">Celular:</label>
                                    <input type="text" class="form-control" id="residente_c_{{$i}}" name="residente_c[]" placeholder="Celular residente:" value="{{old('residente_c.'.$i)}}" >
                                </div>
                            </div>
                            <div class="col-1">
