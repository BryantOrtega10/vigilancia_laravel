...
@section('content')
    <div class="card">
        <form action="{{ route('propiedad.agregar') }}" method="post">
            @csrf
            <div class="card-body">
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select id="tipo_propiedad" name="tipo_propiedad" class="form-control @error('tipo_propiedad') is-invalid @enderror">
                                ...
                                @foreach ($tipos_propiedad as $tipo_propiedad)
                                    <option value="{{ $tipo_propiedad->id }}" @if (old('tipo_propiedad') == $tipo_propiedad->id) selected @endif>{{ $tipo_propiedad->nombre }}</option>
                                @endforeach
                            </select>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-12">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('telefono') is-invalid @enderror" id="telefono" name="telefono" placeholder="Teléfono:" value="{{ old('telefono') }}">
                            @error('telefono')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-md-3 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('contacto') is-invalid @enderror" id="contacto" name="contacto" placeholder="Contacto:" value="{{ old('contacto') }}">
                            @error('contacto')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
